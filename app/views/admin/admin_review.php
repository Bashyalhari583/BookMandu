    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-6">
            <header class="flex items-center justify-between pb-6">
                <h2 class="text-3xl font-semibold">Review Books</h2>
                    ...
                    <table class="min-w-full bg-white">
                        <thead>
                            <tr class="w-full bg-gray-100 text-left">
                                ...
                                <th class="py-3 px-6 text-gray-600">Action1</th>
                                <th class="py-3 px-6 text-gray-600">Action2</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="py-4 px-6">
                                    <form method="post" action="/admin/book/review">
                                    <input type="text" value="<?php echo $book['id'] ?>" name="id" hidden>
                                    <input type="text" value="active" name="state" hidden>
                                    <input type="submit" value="Accept" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
